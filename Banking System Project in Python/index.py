...
def disp_tr_hist(accnt):
	...
	disp_wn.configure(bg="sky blue")
	fr1=tk.Frame(disp_wn,bg="blue")
	l_title=tk.Message(disp_wn,text="TINKA BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="TINKA BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	loginwn.configure(bg="skyblue")
	fr1=tk.Frame(loginwn,bg="white")
	l_title=tk.Message(loginwn,text="TINKA BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	crwn.configure(bg="sky blue")
	fr1=tk.Frame(crwn,bg="white")
	l_title=tk.Message(crwn,text="TINKA BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	# Frame for buttons
	fr_buttons = tk.Frame(rootwn, bg="sky blue")
