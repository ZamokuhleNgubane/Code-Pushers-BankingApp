...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="BANKING SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="BANKING SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	rootwn.configure(background='light blue')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
